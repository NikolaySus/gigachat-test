...
for source in "${sources[@]}"; do
  config="configs/experiments/exp01r_nc_sensitive_source_probe_${source}_4096.json"
  checkpoint_dir="experiments/exp01_reinit_fair/checkpoints/open_ru_1r_nc_sensitive_source_probe_${source}_4096"
  run_name="maxlen-4096-prompt-clean-open_ru_1r_nc_sensitive_source_probe_${source}-fast-sensitive-gate"

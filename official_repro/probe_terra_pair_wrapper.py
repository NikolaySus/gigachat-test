...
VARIANTS: dict[str, tuple[str, str]] = {
    ...
    "logical_premise_consequence": (
        "Логическая предпосылка: ",
        "Логический вывод: ",
    ),
    "logical_basis_consequence": (
        "Логическое основание: ",
        "Логическое следствие: ",
    ),
    "logical_basis_conclusion": (
        "Логическое основание: ",
        "Логический вывод: ",
    ),
    "logical_premise_claim": (
        "Логическая предпосылка: ",
        "Проверяемое логическое утверждение: ",
    ),
    "logical_source_claim": (
        "Исходное логическое утверждение: ",
        "Следующее из него утверждение: ",
    ),
    "logical_text_entailment": (
        "Текст как логическая предпосылка: ",
        "Утверждение как логическое следствие: ",
    ),
    "logical_entails_colon_newline": (
        "Логическая предпосылка:\n",
        "Логическое следствие:\n",
    ),
    "logical_entails_text_fields": (
        "Логическая предпосылка:\nтекст: ",
        "Логическое следствие:\nутверждение: ",
    ),
    "logical_entails_text_fields_cap": (
        "Логическая предпосылка:\nТекст: ",
        "Логическое следствие:\nУтверждение: ",
    ),
    "logical_entails_text_fields_sentence": (
        "Логическая предпосылка:\nпредложение: ",
        "Логическое следствие:\nпредложение: ",
    ),
    "logical_entails_source_claim_fields": (
        "Логическая предпосылка:\nисходный текст: ",
        "Логическое следствие:\nпроверяемое утверждение: ",
    ),
    "logical_entails_source_statement_fields": (
        "Логическая предпосылка:\nисходное утверждение: ",
        "Логическое следствие:\nвыводимое утверждение: ",
    ),
    "logical_entails_proposition_fields": (
        "Логическая предпосылка:\nвысказывание: ",
        "Логическое следствие:\nвысказывание: ",
    ),
    "logical_entails_proposition_fields_cap": (
        "Логическая предпосылка:\nВысказывание: ",
        "Логическое следствие:\nВысказывание: ",
    ),
    "premise_consequence_proposition_fields": (
        "Предпосылка:\nвысказывание: ",
        "Следствие:\nвысказывание: ",
    ),
    "logical_proposition_inline": (
        "Логическая предпосылка-высказывание: ",
        "Логическое следствие-высказывание: ",
    ),
    "proposition_role_inline": (
        "Высказывание-предпосылка: ",
        "Высказывание-следствие: ",
    ),
    "source_result_proposition": (
        "Исходное высказывание: ",
        "Следующее высказывание: ",
    ),
    "given_derived_proposition": (
        "Данное высказывание: ",
        "Выводимое высказывание: ",
    ),
    "base_entailed_proposition": (
        "Высказывание-основание: ",
        "Выводимое из него высказывание: ",
    ),
    "logical_judgement_fields": (
        "Логическая предпосылка:\nсуждение: ",
        "Логическое следствие:\nсуждение: ",
    ),
    "logical_thesis_fields": (
        "Логическая предпосылка:\nтезис: ",
        "Логическое следствие:\nтезис: ",
    ),
    "logical_phrase_fields": (
        "Логическая предпосылка:\nфраза: ",
        "Логическое следствие:\nфраза: ",
    ),
    "logical_statement_ru_fields": (
        "Логическая предпосылка:\nположение: ",
        "Логическое следствие:\nположение: ",
    ),
    "proposition_with_task_context": (
        "Для задачи логического следования, предпосылка:\nвысказывание: ",
        "Для задачи логического следования, следствие:\nвысказывание: ",
    ),
    "proposition_hyp_next": (
        "Логическая предпосылка:\nвысказывание: ",
        "Логическое следствие:\nследующее высказывание: ",
    ),
    "proposition_hyp_derived": (
        "Логическая предпосылка:\nвысказывание: ",
        "Логическое следствие:\nвыводимое высказывание: ",
    ),
    "proposition_hyp_checked": (
        "Логическая предпосылка:\nвысказывание: ",
        "Логическое следствие:\nпроверяемое высказывание: ",
    ),
    "proposition_hyp_claim": (
        "Логическая предпосылка:\nвысказывание: ",
        "Логическое следствие:\nутверждение-высказывание: ",
    ),
    "proposition_hyp_conclusion_statement": (
        "Логическая предпосылка:\nвысказывание: ",
        "Логическое следствие:\nвывод-высказывание: ",
    ),
    "proposition_hyp_entails_from": (
        "Логическая предпосылка:\nвысказывание: ",
        "Логическое следствие:\nвысказывание, следующее из предпосылки: ",
    ),
    "proposition_hyp_should_follow": (
        "Логическая предпосылка:\nвысказывание: ",
        "Логическое следствие:\nвысказывание, которое должно следовать: ",
    ),
    "proposition_hyp_short_follow": (
        "Логическая предпосылка:\nвысказывание: ",
        "Следует высказывание: ",
    ),
    "proposition_hyp_verifiable": (
        "Логическая предпосылка:\nвысказывание: ",
        "Проверяемое по предпосылке высказывание: ",
    ),
    "proposition_hyp_semantic": (
        "Логическая предпосылка:\nвысказывание: ",
        "Семантически следующее высказывание: ",
    ),
    "logical_entails_fact_claim_fields": (
        "Логическая предпосылка:\nфакт: ",
        "Логическое следствие:\nутверждение: ",
    ),
    "logical_entails_context_claim_fields": (
        "Логическая предпосылка:\nконтекст: ",
        "Логическое следствие:\nутверждение: ",
    ),
    "logical_entails_document_claim_fields": (
        "Логическая предпосылка:\nдокумент: ",
        "Логическое следствие:\nутверждение: ",
    ),
    "logical_entails_text_hypothesis_fields": (
        "Логическая предпосылка:\nтекст: ",
        "Логическое следствие:\nгипотеза: ",
    ),
    "logical_entails_premise_hypothesis_fields": (
        "Логическая предпосылка:\nпредпосылка: ",
        "Логическое следствие:\nгипотеза: ",
    ),
    "logical_entails_statement_claim_fields": (
        "Логическая предпосылка:\nутверждение: ",
        "Логическое следствие:\nутверждение: ",
    ),
    "logical_entails_text_only_hypothesis": (
        "текст: ",
        "Логическое следствие:\nутверждение: ",
    ),
    "logical_entails_premise_only_text": (
        "Логическая предпосылка:\nтекст: ",
        "утверждение: ",
    ),
    "logical_entails_question_fields": (
        "Логическая предпосылка:\nдано: ",
        "Логическое следствие:\nследует: ",
    ),
    "logical_statement_follows": (
        "Утверждение, из которого следует вывод: ",
        "Вывод, который следует из утверждения: ",
    ),
    "logical_russian_rte": (
        "Предпосылка в задаче распознавания логического следования: ",
        "Гипотеза в задаче распознавания логического следования: ",
    ),
    "logical_short_follow": (
        "из утверждения следует: ",
        "следствие: ",
    ),
    "entailed_by_text": (
        "Текст-основание: ",
        "Утверждение, выводимое из текста-основания: ",
    ),
